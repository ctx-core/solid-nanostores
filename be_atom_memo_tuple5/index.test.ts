...
import { be_, ctx__new, ns_ctx__new, type wide_ctx_T } from 'ctx-core/be'
import type { Equal, Expect } from 'ctx-core/test'
import { test } from 'uvu'
import { equal } from 'uvu/assert'
import { be_atom_memo_tuple5_, id_be_atom_memo_tuple5_, ns_be_atom_memo_tuple5_ } from '../index.js'
...
test('id_be_atom_memo_tuple5_', ()=>{
	...
	const [
		...
		// foobar__memo,
		// foobar__memo_,
	] = id_be_atom_memo_tuple5_<number, '', WritableAtom_<number>&{
		custom:string
	}>('foobar', ctx=>{
		/* eslint-disable @typescript-eslint/no-unused-vars */
		type test_ctx = Expect<Equal<typeof ctx, wide_ctx_T<''>>>
...
test('ns_be_atom_memo_tuple5_', ()=>{
	...
	const [
		...
		// foobar__memo,
		// foobar__memo_,
	] = ns_be_atom_memo_tuple5_<number, 'test_ns', WritableAtom_<number>&{
		custom:string
	}>('test_ns', ctx=>{
		/* eslint-disable @typescript-eslint/no-unused-vars */
		type test_ctx = Expect<Equal<typeof ctx, wide_ctx_T<'test_ns'>>>
